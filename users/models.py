...
class Profile(models.Model):
    ...
    github_update = models.BooleanField(default = False, null = True, blank = True)
    ...
    github_extra = models.JSONField(default = None, null = True, blank = True)
    github_avatar = models.ImageField(
                        null = True, 
                        blank = True,
                        upload_to = 'profiles/',
                        default = None
                    )
    github_repos = models.JSONField(default = None, null = True, blank = True)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.user.socialaccount_set:
            self.github_extra = self.user.socialaccount_set.all()[0].extra_data
            self.git_username = self.github_extra['login']
